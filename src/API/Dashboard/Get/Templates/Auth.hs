...
notAuthorizedTemplate = do
  Lucid.div_ [Lucid.class_ $ cls [Tokens.errorBg, Tokens.border2, Tokens.errorBorder, "p-8", "text-center"]] $ do
    Lucid.h2_ [Lucid.class_ $ cls [Tokens.text2xl, Tokens.fontBold, Tokens.mb4, Tokens.errorText]] "Access Denied"
    ...
    Lucid.div_ [Lucid.class_ "space-x-4"] $ do
      ...
      Lucid.a_
        [ Lucid.href_ [i|/#{userLoginGetUrl}|],
          ...
          hxTarget_ "#main-content",
          hxPushUrl_ "true",
          Lucid.class_ $ cls ["bg-blue-600", Tokens.textWhite, Tokens.px6, "py-3", Tokens.fontBold, "hover:bg-blue-700", "inline-block"]
        ]
        "LOGIN"
  where
...
notLoggedInTemplate = do
  Lucid.div_ [Lucid.class_ $ cls ["bg-yellow-100", Tokens.border2, "border-yellow-600", "p-8", "text-center"]] $ do
    Lucid.h2_ [Lucid.class_ $ cls [Tokens.text2xl, Tokens.fontBold, Tokens.mb4, "text-yellow-800"]] "Login Required"
