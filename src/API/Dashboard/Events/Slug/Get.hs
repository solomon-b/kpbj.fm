...
module API.Dashboard.Events.Slug.Get (Route, handler) where

--------------------------------------------------------------------------------

import {-# SOURCE #-} API (dashboardEventsGetLink, dashboardEventsNewGetLink, rootGetLink, userLoginGetLink)
