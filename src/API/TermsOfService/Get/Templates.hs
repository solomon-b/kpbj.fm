module API.TermsOfService.Get.Templates
  ( template,
  )
where
...
fallbackContent = "# Terms of Service\n\nWelcome to KPBJ-FM. These Terms of Service govern your use of our website and services."
