...
template displayName fullName emailAddress _redirectLink = do
  ...
  Lucid.div_ [Lucid.class_ $ cls ["max-w-2xl", "mx-auto"], xData_ (alpineState displayNameValue fullNameValue emailValue)] do
    Lucid.div_ [Lucid.class_ $ cls [Tokens.bgWhite, Tokens.cardBorder, "p-8"]] do
      Lucid.div_ [Lucid.class_ $ cls ["text-center", Tokens.mb8]] do
        Lucid.h3_ [Lucid.class_ $ cls [Tokens.text2xl, Tokens.fontBold, Tokens.mb2]] "CREATE ACCOUNT"
        Lucid.div_ [Lucid.class_ $ cls [Tokens.textSm, Tokens.textGray600]] "Join the KPBJ community and unlock exclusive features"

      Lucid.form_ [hxPost_ [i|/#{userRegisterPostUrl}|], Lucid.class_ "space-y-6"] do
        validationNotice

        Lucid.div_ [Lucid.class_ "space-y-4"] do
          Lucid.h3_ [Lucid.class_ $ cls [Tokens.fontBold, Tokens.textLg, "border-b", "border-gray-300", Tokens.pb2]] "Personal Information"
          fullNameField
          emailField

        Lucid.div_ [Lucid.class_ "space-y-4"] do
          Lucid.h3_ [Lucid.class_ $ cls [Tokens.fontBold, Tokens.textLg, "border-b", "border-gray-300", Tokens.pb2]] "Account Setup"
          displayNameField
          Lucid.div_ [Lucid.class_ $ cls ["grid", "grid-cols-1", md "grid-cols-2", Tokens.gap4]] do
            passwordField
      ...
      Lucid.div_ [Lucid.class_ $ cls ["mt-8", "pt-6", "border-t", "border-gray-300", "text-center"]] do
        Lucid.div_ [Lucid.class_ $ cls [Tokens.textSm, Tokens.textGray600, Tokens.mb4]] "Already have an account?"
        Lucid.a_ [Lucid.href_ [i|/#{userLoginGetUrl}|], hxGet_ [i|/#{userLoginGetUrl}|], hxSwap_ "innerHTML", hxTarget_ "body", hxPushUrl_ "true", Lucid.class_ $ cls ["bg-blue-600", Tokens.textWhite, Tokens.px6, "py-3", Tokens.fontBold, "hover:bg-blue-700", "inline-block"]] "LOGIN"

    Lucid.div_ [Lucid.class_ $ cls [Tokens.bgGray100, Tokens.border2, "border-gray-400", Tokens.p6, "mt-6"]] do
      Lucid.h3_ [Lucid.class_ $ cls [Tokens.fontBold, Tokens.mb4]] "WHAT YOU GET WITH AN ACCOUNT"
      Lucid.div_ [Lucid.class_ $ cls ["grid", "grid-cols-1", md "grid-cols-2", Tokens.gap4, Tokens.textSm]] do
      ...
      Lucid.div_ [Lucid.class_ $ cls ["mt-4", Tokens.p3, "bg-blue-50", "border", "border-blue-400", Tokens.textSm]] do
        Lucid.div_ [Lucid.class_ $ cls [Tokens.fontBold, "text-blue-800", "mb-1"]] "Interested in Hosting?"
...
displayNameField =
  Lucid.div_ do
    Lucid.label_
      [Lucid.for_ "displayName", Lucid.class_ $ cls ["block", Tokens.fontBold, Tokens.mb2]]
      "Username *"
    Lucid.input_
      [ Lucid.type_ "text",
    ...
    Lucid.div_ [Lucid.class_ $ cls [Tokens.textXs, Tokens.textGray600, "mt-1"]] "This will be your public display name on the site"

fullNameField :: Lucid.Html ()
fullNameField =
  Lucid.div_ do
    Lucid.label_
      [Lucid.for_ "fullName", Lucid.class_ $ cls ["block", Tokens.fontBold, Tokens.mb2]]
      "Full Name *"
    Lucid.input_
      [ Lucid.type_ "text",
...
emailField =
  Lucid.div_ do
    ...
    Lucid.div_ [Lucid.class_ $ cls [Tokens.textXs, Tokens.textGray600, "mt-1"]] "We'll use this for account notifications and important updates"
...
confirmPasswordField =
  Lucid.div_ [] do
    Lucid.label_
      [Lucid.for_ "confirmPassword", Lucid.class_ $ cls ["block", Tokens.fontBold, Tokens.mb2]]
      "Confirm Password *"
    Lucid.input_
      [ Lucid.type_ "password",
...
passwordRequirements =
  Lucid.div_ [Lucid.class_ $ cls [Tokens.bgGray100, "border", "border-gray-300", Tokens.p3, Tokens.textXs]] do
    Lucid.div_ [Lucid.class_ $ cls [Tokens.fontBold, "mb-1"]] "Password Requirements:"
...
newsletterCheckbox =
  Lucid.div_ [Lucid.class_ $ cls ["flex", "items-start"]] do
...
termsCheckbox =
  Lucid.div_ [Lucid.class_ $ cls ["flex", "items-start"], xBindClass_ "showErrors && !termsValid ? 'flex items-start p-2 border-2 border-red-500 bg-red-50' : 'flex items-start'"] do
    ...
    Lucid.label_ [Lucid.for_ "terms", Lucid.class_ Tokens.textSm] do
      ...
      Lucid.div_ [Lucid.class_ Tokens.textGray600] do
        ...
        Lucid.a_ [Lucid.href_ [i|/#{termsOfServiceGetUrl}|], hxGet_ [i|/#{termsOfServiceGetUrl}|], hxSwap_ "innerHTML", hxTarget_ "body", hxPushUrl_ "true", Lucid.class_ $ cls ["text-blue-600", "hover:underline"]] "Terms of Service"
        Lucid.span_ " and "
        Lucid.a_ [Lucid.href_ [i|/#{privacyPolicyGetUrl}|], hxGet_ [i|/#{privacyPolicyGetUrl}|], hxSwap_ "innerHTML", hxTarget_ "body", hxPushUrl_ "true", Lucid.class_ $ cls ["text-blue-600", "hover:underline"]] "Privacy Policy"

submitButton :: Lucid.Html ()
submitButton =
  Lucid.button_
    [ Lucid.type_ "submit",
      Lucid.class_ $ cls [Tokens.fullWidth, "bg-green-600", Tokens.textWhite, Tokens.p3, Tokens.fontBold, "hover:bg-green-700", "transition-colors"],
