...
import Design.Tokens (textGray800, mb6, mb8, fontMedium)
...
template :: Lucid.Html ()
template = do
  Lucid.div_ [Lucid.class_ $ cls ["prose", "prose-lg", textGray800]] $ do
    Lucid.p_
      [Lucid.class_ $ cls [mb6, "leading-relaxed"]]
