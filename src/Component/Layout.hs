...
grid mobileCols tabletCols desktopCols gapClass =
  Lucid.div_ [Lucid.class_ $ cls [Tokens.responsiveGrid mobileCols tabletCols desktopCols, gapClass]]
...
cardGrid mobileCols tabletCols desktopCols =
  Lucid.div_
    [ Lucid.class_ $
        cls
          [ Tokens.responsiveGrid mobileCols tabletCols desktopCols,
            Tokens.gap4,
            md Tokens.gap6,
            Tokens.mb6,
            md Tokens.mb8,
...
twoColumn left right =
  Lucid.div_ [Lucid.class_ $ cls [Tokens.responsiveGrid 1 2 2, Tokens.gap6]] $ do
    Lucid.div_ left
    Lucid.div_ right
...
threeColumn col1 col2 col3 =
  Lucid.div_ [Lucid.class_ $ cls [Tokens.responsiveGrid 1 2 3, Tokens.gap6]] $ do
    Lucid.div_ col1
    Lucid.div_ col2
    Lucid.div_ col3
...
stackToRow gapClass = Lucid.div_ [Lucid.class_ $ cls [Tokens.stackToRow, "items-start", md "items-center", gapClass]]
