...
module API.User.Login.Form where
  ...
  Lucid.div_ do
    ...
    Lucid.input_
      [ Lucid.type_ "email",
        ...
        xBindClass_ "fields.email.isValid ? 'w-full p-3 border-2 border-gray-400 font-mono focus:border-blue-600' : 'w-full p-3 border-2 border-red-500 font-mono focus:border-red-600'",
  ...
  Lucid.div_ [] do
    ...
    Lucid.input_
      [ Lucid.type_ "password",
        ...
        xData_ "alpineHandler",
        xBindClass_ "fields.password.isValid ? 'w-full p-3 border-2 border-gray-400 font-mono focus:border-blue-600' : 'w-full p-3 border-2 border-red-500 font-mono focus:border-red-600'",
