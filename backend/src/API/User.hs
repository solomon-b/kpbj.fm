...
type UserAPI =
  Servant.Get '[Servant.JSON] [User]
    ...
    :<|> "register" :> Servant.ReqBody '[Servant.JSON] Register :> Servant.Post '[Servant.JSON] Effects.Auth.JWTToken
    :<|> "login" :> Servant.ReqBody '[Servant.JSON] Login :> Servant.Post '[Servant.JSON] Effects.Auth.JWTToken
