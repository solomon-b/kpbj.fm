...
- **Multi-Browser Testing** - Playwright config runs tests across Chromium, Firefox, iPhone 13 (Chromium), and Pixel 5 (Android) viewports. WebKit disabled on NixOS due to WPE EGL display incompatibility.
