...
SELECT * FROM (VALUES
  (
    ...
    'images/2025/01/01/blog-heroes/kpbj-wins-2025-community-radio-excellence-award.jpg',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/behind-the-scenes-day-in-life-kpbj-host.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/new-shows-premiering-fall-2025.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/portland-underground-music-scene-venues-matter.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/fundraising-update-summer-2025-pledge-drive.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/discovering-hidden-gems-vinyl-shopping-portland.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/community-voices-listeners-shape-programming.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
  ...
  (
    ...
    'images/2025/01/01/blog-heroes/looking-ahead-kpbj-plans-2026.jpg',
    (SELECT id FROM users WHERE email = 'staff@kpbj.fm'),
    'published',
