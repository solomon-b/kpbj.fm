...
import API.Dashboard.Shows.Slug.Delete.Handler qualified as Dashboard.Shows.Slug.Delete
    ...
    dashboardStreamSettingsRoutes =
      DashboardStreamSettingsRoutes
        { get = Dashboard.StreamSettings.Get.handler,
          ...
          stopStreamPost = Dashboard.StreamSettings.StopStream.Post.handler,
          startStreamPost = Dashboard.StreamSettings.StartStream.Post.handler
        }
    ...
    dashboardEventsRoutes =
      DashboardEventsRoutes
        { list = Dashboard.Events.Get.handler,
          ...
          feature = Dashboard.Events.Slug.Feature.Post.handler
        }
