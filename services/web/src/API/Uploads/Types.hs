...
import Servant.Multipart (FileData, FromMultipart, MultipartData, Tmp, fromMultipart, lookupFile, lookupInput)
...
instance FromMultipart Tmp AudioUploadForm where
...
parseUploadType :: MultipartData Tmp -> Either String StagedUploads.UploadType
parseUploadType multipartData =
