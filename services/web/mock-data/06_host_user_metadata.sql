...
SELECT
    ...
    CASE s.slug
        WHEN 'sunday-morning-jazz' THEN 'images/avatars/2025/01/01/smooth-sullivan.jpg'
        WHEN 'gospel-hour' THEN 'images/avatars/2025/01/01/sister-joy.jpg'
        WHEN 'world-music-passport' THEN 'images/avatars/2025/01/01/dj-wanderlust.jpg'
        WHEN 'classical-sundays' THEN 'images/avatars/2025/01/01/maestro-chen.jpg'
        WHEN 'indie-mixtape' THEN 'images/avatars/2025/01/01/cassette-kid.jpg'
        WHEN 'soul-kitchen' THEN 'images/avatars/2025/01/01/chef-groove.jpg'
        WHEN 'acoustic-sessions' THEN 'images/avatars/2025/01/01/willow-hart.jpg'
        WHEN 'electronic-sunday' THEN 'images/avatars/2025/01/01/circuit-breaker.jpg'
        WHEN 'reggae-vibes' THEN 'images/avatars/2025/01/01/irie-lion.jpg'
        WHEN 'blues-after-dark' THEN 'images/avatars/2025/01/01/midnight-willie.jpg'
        WHEN 'experimental-sounds' THEN 'images/avatars/2025/01/01/the-sound-scientist.jpg'
        WHEN 'midnight-ambient' THEN 'images/avatars/2025/01/01/lunar-drift.jpg'
        WHEN 'monday-morning-wake-up' THEN 'images/avatars/2025/01/01/sunrise-sam.jpg'
        WHEN 'hip-hop-fundamentals' THEN 'images/avatars/2025/01/01/dj-knowledge.jpg'
        WHEN 'punk-power-hour' THEN 'images/avatars/2025/01/01/spike-voltage.jpg'
        WHEN 'metal-madness' THEN 'images/avatars/2025/01/01/thor-the-destroyer.jpg'
        WHEN 'late-night-chill' THEN 'images/avatars/2025/01/01/luna-waves.jpg'
        WHEN 'psychedelic-journey' THEN 'images/avatars/2025/01/01/cosmic-carl.jpg'
        WHEN 'dub-vibrations' THEN 'images/avatars/2025/01/01/bass-commander.jpg'
        WHEN 'shoegaze-and-dream-pop' THEN 'images/avatars/2025/01/01/reverb-rachel.jpg'
        WHEN 'new-wave-nostalgia' THEN 'images/avatars/2025/01/01/neon-nancy.jpg'
        WHEN 'techno-territory' THEN 'images/avatars/2025/01/01/berlin-bob.jpg'
        WHEN 'witch-house' THEN 'images/avatars/2025/01/01/hex-hannah.jpg'
        WHEN 'disco-fever' THEN 'images/avatars/2025/01/01/disco-donna.jpg'
        WHEN 'black-metal' THEN 'images/avatars/2025/01/01/frost-fenrir.jpg'
        WHEN 'vaporwave-dreams' THEN 'images/avatars/2025/01/01/aesthetic-andy.jpg'
        WHEN 'drum-and-bass' THEN 'images/avatars/2025/01/01/jungle-jane.jpg'
        WHEN 'synthwave-night' THEN 'images/avatars/2025/01/01/retro-racer-rita.jpg'
        WHEN 'ambient-soundscapes' THEN 'images/avatars/2025/01/01/ambient-aurora.jpg'
        ELSE NULL
    END as avatar_url,
    'Host' as user_role
FROM users u
